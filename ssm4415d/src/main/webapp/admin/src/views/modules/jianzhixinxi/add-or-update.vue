<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="兼职地点" prop="jianzhididian">
          <el-select v-model="ruleForm.jianzhididian" placeholder="请选择兼职地点">
            <el-option
                v-for="(item,index) in jianzhididianOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="兼职地点" prop="jianzhididian">
	      <el-input v-model="ruleForm.jianzhididian"
                placeholder="兼职地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="职位薪资" prop="zhiweixinzi">
          <el-input v-model="ruleForm.zhiweixinzi" 
              placeholder="职位薪资" clearable  :readonly="ro.zhiweixinzi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="职位薪资" prop="zhiweixinzi">
              <el-input v-model="ruleForm.zhiweixinzi" 
                placeholder="职位薪资" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.gongsitupian" label="公司图片" prop="gongsitupian">
          <file-upload
          tip="点击上传公司图片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.gongsitupian" label="公司图片" prop="gongsitupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.gongsitupian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.gongsimingcheng = true;
          ...
          if(o=='jianzhididian'){
            this.ruleForm.jianzhididian = obj[o];
	    this.ro.jianzhididian = true;
            continue;
          }
	    ...
	    this.ro.zhiweiyaoqiu = true;
          ...
          if(o=='zhiweixinzi'){
            this.ruleForm.zhiweixinzi = obj[o];
	    this.ro.zhiweixinzi = true;
            continue;
          }
          if(o=='gongzuoshijian'){
