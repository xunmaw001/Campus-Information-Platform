<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商品描述" prop="shangpinmiaoshu">
          <el-input v-model="ruleForm.shangpinmiaoshu" 
              placeholder="商品描述" clearable  :readonly="ro.shangpinmiaoshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商品描述" prop="shangpinmiaoshu">
              <el-input v-model="ruleForm.shangpinmiaoshu" 
                placeholder="商品描述" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="卖家手机" prop="maijiashouji">
          <el-input v-model="ruleForm.maijiashouji" 
              placeholder="卖家手机" clearable  :readonly="ro.maijiashouji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="卖家手机" prop="maijiashouji">
              <el-input v-model="ruleForm.maijiashouji" 
                placeholder="卖家手机" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="交易时间" prop="jiaoyishijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jiaoyishijian" label="交易时间" prop="jiaoyishijian">
              <el-input v-model="ruleForm.jiaoyishijian" 
                placeholder="交易时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
      ...
      this.$http({
		...
		if(json.shouji!=''&&json.shouji){
          ...
          this.$message.error(data.msg);
            ...
            this.jiaoyifangshiOptions = "面对面交易,送货上门".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
