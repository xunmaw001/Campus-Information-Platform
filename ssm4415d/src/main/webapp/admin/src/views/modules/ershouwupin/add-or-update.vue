<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="物品分类" prop="wupinfenlei">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
		...
		if(json.maijiashouji!=''&&json.maijiashouji){
              		this.ruleForm.maijiashouji = json.maijiashouji
		}
        } else {
	...
	this.ruleForm.shangpinmiaoshu = this.ruleForm.shangpinmiaoshu.replace(reg,'../../../ssm4415d/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
