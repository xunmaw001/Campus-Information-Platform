...
public class DiscussershouwupinController {
    ...
    public R save(@RequestBody DiscussershouwupinEntity discussershouwupin, HttpServletRequest request){
    	discussershouwupin.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<DiscussershouwupinEntity> wrapper = new EntityWrapper<DiscussershouwupinEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = discussershouwupinService.selectCount(wrapper);
